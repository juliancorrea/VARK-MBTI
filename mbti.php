        ...
        <form>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions2" id="inlineRadio7"
                                value="Introvertido_A">
                            <label class="form-check-label" for="inlineRadio7">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions2" id="inlineRadio8"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions3" id="inlineRadio9"
                                value="Extrovertido_TD">
                            <label class="form-check-label" for="inlineRadio9">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions3" id="inlineRadio10"
                                value="Extrovertido_D">
                            <label class="form-check-label" for="inlineRadio10">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions3" id="inlineRadio11"
                                value="Extrovertido_A">
                            <label class="form-check-label" for="inlineRadio11">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions3" id="inlineRadio12"
                                value="Extrovertido_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions4" id="inlineRadio13"
                                value="Introvertido_TD">
                            <label class="form-check-label" for="inlineRadio13">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions4" id="inlineRadio14"
                                value="Introvertido_D">
                            <label class="form-check-label" for="inlineRadio14">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions4" id="inlineRadio15"
                                value="Introvertido_A">
                            <label class="form-check-label" for="inlineRadio15">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions4" id="inlineRadio16"
                                value="Introvertido_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions5" id="inlineRadio17"
                                value="Extrovertido_TD">
                            <label class="form-check-label" for="inlineRadio17">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions5" id="inlineRadio18"
                                value="Extrovertido_D">
                            <label class="form-check-label" for="inlineRadio18">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions5" id="inlineRadio19"
                                value="Extrovertido_A">
                            <label class="form-check-label" for="inlineRadio19">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions5" id="inlineRadio20"
                                value="Extrovertido_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions6" id="inlineRadio21"
                                value="Introvertido_TD">
                            <label class="form-check-label" for="inlineRadio21">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions6" id="inlineRadio22"
                                value="Introvertido_D">
                            <label class="form-check-label" for="inlineRadio22">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions6" id="inlineRadio23"
                                value="Introvertido_A">
                            <label class="form-check-label" for="inlineRadio23">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions6" id="inlineRadio24"
                                value="Introvertido_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions7" id="inlineRadio25"
                                value="Extrovertido_TD">
                            <label class="form-check-label" for="inlineRadio25">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions7" id="inlineRadio26"
                                value="Extrovertido_D">
                            <label class="form-check-label" for="inlineRadio26">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions7" id="inlineRadio27"
                                value="Extrovertido_A">
                            <label class="form-check-label" for="inlineRadio27">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions7" id="inlineRadio28"
                                value="Extrovertido_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions8" id="inlineRadio29"
                                value="Introvertido_TD">
                            <label class="form-check-label" for="inlineRadio29">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions8" id="inlineRadio30"
                                value="Introvertido_D">
                            <label class="form-check-label" for="inlineRadio30">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions8" id="inlineRadio31"
                                value="Introvertido_A">
                            <label class="form-check-label" for="inlineRadio31">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions8" id="inlineRadio32"
                                value="Introvertido_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions9" id="inlineRadio33"
                                value="Extrovertido_TD">
                            <label class="form-check-label" for="inlineRadio33">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions9" id="inlineRadio34"
                                value="Extrovertido_D">
                            <label class="form-check-label" for="inlineRadio34">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions9" id="inlineRadio35"
                                value="Extrovertido_A">
                            <label class="form-check-label" for="inlineRadio35">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions9" id="inlineRadio36"
                                value="Extrovertido_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions10" id="inlineRadio37"
                                value="Intuitivo_TD">
                            <label class="form-check-label" for="inlineRadio37">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions10" id="inlineRadio38"
                                value="Intuitivo_D">
                            <label class="form-check-label" for="inlineRadio38">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions10" id="inlineRadio39"
                                value="Intuitivo_A">
                            <label class="form-check-label" for="inlineRadio39">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions10" id="inlineRadio40"
                                value="Intuitivo_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions11" id="inlineRadio41"
                                value="Sensorial_TD">
                            <label class="form-check-label" for="inlineRadio41">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions11" id="inlineRadio42"
                                value="Sensorial_D">
                            <label class="form-check-label" for="inlineRadio42">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions11" id="inlineRadio43"
                                value="Sensorial_A">
                            <label class="form-check-label" for="inlineRadio43">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions11" id="inlineRadio44"
                                value="Sensorial_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions12" id="inlineRadio45"
                                value="Intuitivo_TD">
                            <label class="form-check-label" for="inlineRadio45">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions12" id="inlineRadio46"
                                value="Intuitivo_D">
                            <label class="form-check-label" for="inlineRadio46">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions12" id="inlineRadio47"
                                value="Intuitivo_A">
                            <label class="form-check-label" for="inlineRadio47">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions12" id="inlineRadio48"
                                value="Intuitivo_TA">
            ...
            <div class="card">
                ...
                <div class="text-center">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions13" id="inlineRadio49"
                            value="Sensorial_TD">
                        <label class="form-check-label" for="inlineRadio49">Totalmente en desacuerdo</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions13" id="inlineRadio50"
                            value="Sensorial_D">
                        <label class="form-check-label" for="inlineRadio50">En desacuerdo</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions13" id="inlineRadio51"
                            value="Sensorial_A">
                        <label class="form-check-label" for="inlineRadio51">De acuerdo</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions13" id="inlineRadio52"
                            value="Sensorial_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions14" id="inlineRadio53"
                                value="Intuitivo_TD">
                            <label class="form-check-label" for="inlineRadio53">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions14" id="inlineRadio54"
                                value="Intuitivo_D">
                            <label class="form-check-label" for="inlineRadio54">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions14" id="inlineRadio55"
                                value="Intuitivo_A">
                            <label class="form-check-label" for="inlineRadio55">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions14" id="inlineRadio56"
                                value="Intuitivo_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions15" id="inlineRadio57"
                                value="Sensorial_TD">
                            <label class="form-check-label" for="inlineRadio57">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions15" id="inlineRadio58"
                                value="Sensorial_D">
                            <label class="form-check-label" for="inlineRadio58">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions15" id="inlineRadio59"
                                value="Sensorial_A">
                            <label class="form-check-label" for="inlineRadio59">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions15" id="inlineRadio60"
                                value="Sensorial_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions16" id="inlineRadio61"
                                value="Intuitivo_TD">
                            <label class="form-check-label" for="inlineRadio61">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions16" id="inlineRadio62"
                                value="Intuitivo_D">
                            <label class="form-check-label" for="inlineRadio62">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions16" id="inlineRadio63"
                                value="Intuitivo_A">
                            <label class="form-check-label" for="inlineRadio63">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions16" id="inlineRadio64"
                                value="Intuitivo_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions17" id="inlineRadio65"
                                value="Sensorial_TD">
                            <label class="form-check-label" for="inlineRadio65">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions17" id="inlineRadio66"
                                value="Sensorial_D">
                            <label class="form-check-label" for="inlineRadio66">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions17" id="inlineRadio67"
                                value="Sensorial_A">
                            <label class="form-check-label" for="inlineRadio67">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions17" id="inlineRadio68"
                                value="Sensorial_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions18" id="inlineRadio69"
                                value="Intuitivo_TD">
                            <label class="form-check-label" for="inlineRadio69">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions18" id="inlineRadio70"
                                value="Intuitivo_D">
                            <label class="form-check-label" for="inlineRadio70">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions18" id="inlineRadio71"
                                value="Intuitivo_A">
                            <label class="form-check-label" for="inlineRadio71">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions18" id="inlineRadio72"
                                value="Intuitivo_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions19" id="inlineRadio73"
                                value="Racional_TD">
                            <label class="form-check-label" for="inlineRadio73">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions19" id="inlineRadio74"
                                value="Racional_D">
                            <label class="form-check-label" for="inlineRadio74">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions19" id="inlineRadio75"
                                value="Racional_A">
                            <label class="form-check-label" for="inlineRadio75">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions19" id="inlineRadio76"
                                value="Racional_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions20" id="inlineRadio77"
                                value="Emocional_TD">
                            <label class="form-check-label" for="inlineRadio77">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions20" id="inlineRadio78"
                                value="Emocional_D">
                            <label class="form-check-label" for="inlineRadio78">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions20" id="inlineRadio79"
                                value="Emocional_A">
                            <label class="form-check-label" for="inlineRadio79">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions20" id="inlineRadio80"
                                value="Emocional_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions21" id="inlineRadio81"
                                value="Racional_TD">
                            <label class="form-check-label" for="inlineRadio81">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions21" id="inlineRadio82"
                                value="Racional_D">
                            <label class="form-check-label" for="inlineRadio82">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions21" id="inlineRadio83"
                                value="Racional_A">
                            <label class="form-check-label" for="inlineRadio83">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions21" id="inlineRadio84"
                                value="Racional_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions22" id="inlineRadio85"
                                value="Emocional_TD">
                            <label class="form-check-label" for="inlineRadio85">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions22" id="inlineRadio86"
                                value="Emocional_D">
                            <label class="form-check-label" for="inlineRadio86">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions22" id="inlineRadio87"
                                value="Emocional_A">
                            <label class="form-check-label" for="inlineRadio87">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions22" id="inlineRadio88"
                                value="Emocional_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions23" id="inlineRadio89"
                                value="Racional_TD">
                            <label class="form-check-label" for="inlineRadio89">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions23" id="inlineRadio90"
                                value="Racional_D">
                            <label class="form-check-label" for="inlineRadio90">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions23" id="inlineRadio91"
                                value="Racional_A">
                            <label class="form-check-label" for="inlineRadio91">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions23" id="inlineRadio92"
                                value="Racional_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions24" id="inlineRadio93"
                                value="Emocional_TD">
                            <label class="form-check-label" for="inlineRadio93">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions24" id="inlineRadio94"
                                value="Emocional_D">
                            <label class="form-check-label" for="inlineRadio94">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions24" id="inlineRadio95"
                                value="Emocional_A">
                            <label class="form-check-label" for="inlineRadio95">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions24" id="inlineRadio96"
                                value="Emocional_TA">
            ...
            <div class="card">
                ...
                <div class="text-center">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions25" id="inlineRadio97"
                            value="Racional_TD">
                        <label class="form-check-label" for="inlineRadio97">Totalmente en desacuerdo</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions25" id="inlineRadio98"
                            value="Racional_D">
                        <label class="form-check-label" for="inlineRadio98">En desacuerdo</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions25" id="inlineRadio99"
                            value="Racional_A">
                        <label class="form-check-label" for="inlineRadio99">De acuerdo</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions25" id="inlineRadio100"
                            value="Racional_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions26" id="inlineRadio101"
                                value="Emocional_TD">
                            <label class="form-check-label" for="inlineRadio101">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions26" id="inlineRadio102"
                                value="Emocional_D">
                            <label class="form-check-label" for="inlineRadio102">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions26" id="inlineRadio103"
                                value="Emocional_A">
                            <label class="form-check-label" for="inlineRadio103">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions26" id="inlineRadio104"
                                value="Emocional_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions27" id="inlineRadio105"
                                value="Racional_TD">
                            <label class="form-check-label" for="inlineRadio105">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions27" id="inlineRadio106"
                                value="Racional_D">
                            <label class="form-check-label" for="inlineRadio106">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions27" id="inlineRadio107"
                                value="Racional_A">
                            <label class="form-check-label" for="inlineRadio107">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions27" id="inlineRadio108"
                                value="Racional_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions28" id="inlineRadio109"
                                value="Perceptivo_TD">
                            <label class="form-check-label" for="inlineRadio109">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions28" id="inlineRadio110"
                                value="Perceptivo_D">
                            <label class="form-check-label" for="inlineRadio110">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions28" id="inlineRadio111"
                                value="Perceptivo_A">
                            <label class="form-check-label" for="inlineRadio111">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions28" id="inlineRadio112"
                                value="Perceptivo_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions29" id="inlineRadio113"
                                value="Calificador_TD">
                            <label class="form-check-label" for="inlineRadio113">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions29" id="inlineRadio114"
                                value="Calificador_D">
                            <label class="form-check-label" for="inlineRadio114">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions29" id="inlineRadio115"
                                value="Calificador_A">
                            <label class="form-check-label" for="inlineRadio115">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions29" id="inlineRadio116"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions30" id="inlineRadio117"
                                value="Perceptivo_TD">
                            <label class="form-check-label" for="inlineRadio117">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions30" id="inlineRadio118"
                                value="Perceptivo_D">
                            <label class="form-check-label" for="inlineRadio118">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions30" id="inlineRadio119"
                                value="Perceptivo_A">
                            <label class="form-check-label" for="inlineRadio119">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions30" id="inlineRadio120"
                                value="Perceptivo_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions31" id="inlineRadio121"
                                value="Calificador_TD">
                            <label class="form-check-label" for="inlineRadio121">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions31" id="inlineRadio122"
                                value="Calificador_D">
                            <label class="form-check-label" for="inlineRadio122">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions31" id="inlineRadio123"
                                value="Calificador_A">
                            <label class="form-check-label" for="inlineRadio123">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions31" id="inlineRadio124"
                                value="Calificador_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions32" id="inlineRadio125"
                                value="Perceptivo_TD">
                            <label class="form-check-label" for="inlineRadio125">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions32" id="inlineRadio126"
                                value="Perceptivo_D">
                            <label class="form-check-label" for="inlineRadio126">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions32" id="inlineRadio127"
                                value="Perceptivo_A">
                            <label class="form-check-label" for="inlineRadio127">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions32" id="inlineRadio128"
                                value="Perceptivo_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions33" id="inlineRadio129"
                                value="Calificador_TD">
                            <label class="form-check-label" for="inlineRadio129">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions33" id="inlineRadio130"
                                value="Calificador_D">
                            <label class="form-check-label" for="inlineRadio130">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions33" id="inlineRadio131"
                                value="Calificador_A">
                            <label class="form-check-label" for="inlineRadio131">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions33" id="inlineRadio132"
                                value="Calificador_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions34" id="inlineRadio133"
                                value="Perceptivo_TD">
                            <label class="form-check-label" for="inlineRadio133">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions34" id="inlineRadio134"
                                value="Perceptivo_D">
                            <label class="form-check-label" for="inlineRadio134">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions34" id="inlineRadio135"
                                value="Perceptivo_A">
                            <label class="form-check-label" for="inlineRadio135">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions34" id="inlineRadio136"
                                value="Perceptivo_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions35" id="inlineRadio137"
                                value="Calificador_TD">
                            <label class="form-check-label" for="inlineRadio137">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions35" id="inlineRadio138"
                                value="Calificador_D">
                            <label class="form-check-label" for="inlineRadio138">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions35" id="inlineRadio139"
                                value="Calificador_A">
                            <label class="form-check-label" for="inlineRadio139">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions35" id="inlineRadio140"
                                value="Calificador_TA">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions36" id="inlineRadio141"
                                value="Perceptivo_TD">
                            <label class="form-check-label" for="inlineRadio141">Totalmente en desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions36" id="inlineRadio142"
                                value="Perceptivo_D">
                            <label class="form-check-label" for="inlineRadio142">En desacuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions36" id="inlineRadio143"
                                value="Perceptivo_A">
                            <label class="form-check-label" for="inlineRadio143">De acuerdo</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions36" id="inlineRadio144"
                                value="Perceptivo_TA">
